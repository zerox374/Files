...
> <:emoji_3:1504320257412562985> **[${info.title || 'Unknown Title'}](${info.uri || 'https://youtube.com'})** added to queue.
  ...
  if (interaction.isButton()) {
    ...
    switch (interaction.customId) {
      ...
      case 'stop': {
        ...
        await interaction.followUp({ content: '✅ Music playback has been stopped and the queue has been cleared.' }).catch(() => {});
        player.destroy();
        break;
      }
...
> My Prefix for this Server is \`..\` Use \`.help\` to see all commands.`
    });
  }
});
